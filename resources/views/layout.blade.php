...
<body>
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    ...
                    @if(Auth::check() && Auth::user()->role_id == '1') 
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="{{ route('total_participants') }}"
                                aria-expanded="false">
                                <i class="fas fa-users" aria-hidden="true"></i>
                                <span class="hide-menu">Total Participants</span>
                            </a>
                        </li>
                        @endif
            ...
            success: function(data){
                if(data.length > 0){
                    ...
                    $.each(data, function(key, speaker){
                        ...
                        var buttons = '<a href="speaker/edit/'+speaker.id+'" class="btn btn-info"><i class="fa fa-pencil-alt" aria-hidden="true"></i> Edit</a>&nbsp;&nbsp;<a onclick="delete_speaker('+speaker.id+')" class="btn btn-danger"><i class="fa fa-trash" aria-hidden="true"></i> Delete</a>';
            ...
            success: function(data){
                if(data.length > 0){
                    ...
                    $.each(data, function(key, event){
                        ...
                        var buttons = '<a href="event/edit/'+event.id+'" class="btn btn-info"><i class="fa fa-pencil-alt" aria-hidden="true"></i> Edit</a>&nbsp;&nbsp;<a onclick="delete_event('+event.id+')" class="btn btn-danger"><i class="fa fa-trash" aria-hidden="true"></i> Delete</a>';
            ...
            success: function(data){
                if(data.length > 0){
                    ...
                    $.each(data, function(key, tag){
                        ...
                        var buttons = '<a href="tag/edit/'+tag.id+'" class="btn btn-info"><i class="fa fa-pencil-alt" aria-hidden="true"></i> Edit</a>&nbsp;&nbsp;<a onclick="delete_tag('+tag.id+')" class="btn btn-danger"><i class="fa fa-trash" aria-hidden="true"></i> Delete</a>';
            ...
            success: function(data){
                if(data.length > 0){
                    ...
                    $.each(data, function(key, rating){
                        ...
                        var buttons = '<a href="rating/edit/'+rating.id+'" class="btn btn-info"><i class="fa fa-pencil-alt" aria-hidden="true"></i> Edit</a>&nbsp;&nbsp;<a onclick="delete_rating('+rating.id+')" class="btn btn-danger"><i class="fa fa-trash" aria-hidden="true"></i> Delete</a>';
            ...
            success: function(data){
                if(data.talks.length > 0){
                    ...
                    $.each(data.talks, function(key, talk){
                        ...
                        var buttons = '<a href="talks/edit/'+talk.id+'" class="btn btn-info"><i class="fa fa-pencil-alt" aria-hidden="true"></i> Edit</a><a onclick="delete_talk('+talk.id+')" class="btn btn-danger"><i class="fa fa-trash" aria-hidden="true"></i> Delete</a>';
    ...
    function load_total_participants(){
        $.ajax({
            url: "{{ route('load_total_participants') }}",
            method: "POST",
            data: { "_token": "{{ csrf_token() }}" },
            success: function(data){
                if(data.talks.length > 0){
                    ...
                    $.each(data.talks, function(key, talk){
                        ...
                        table_row += "<td class='text-center'>"+counter+"</td>";
                        table_row += "<td>"+talk.name+"</td>";
                        table_row += "<td class='text-center'>"+talk.total_participants+"</td>";
                        table_row += "</tr>";
    ...
    function delete_talk(id){
        swal({
            ...
            window.location = "talks/delete/"+id;
        });
    }
    ...
    function delete_rating(id){
        swal({
            ...
            window.location = "rating/delete/"+id;
        });
    }
    ...
    function delete_speaker(id){
        swal({
            ...
            window.location = "speaker/delete/"+id;
        });
    }
