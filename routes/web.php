...
Route::get('/talks/total_participants', 'TalksController@total_participants')->name('total_participants');
Route::post('/talks/load_total_participants', 'TalksController@load_total_participants')->name('load_total_participants');
